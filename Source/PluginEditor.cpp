...
{
    presetSelect.addItem("def", 1);
    presetSelect.addItem("grap", 2);
    presetSelect.addItem("loc", 3);
    addAndMakeVisible(presetSelect);
    presetSelectAttachment = std::make_unique<juce::AudioProcessorValueTreeState::ComboBoxAttachment>(audioProcessor.apvts, "MICOMBO_ID", presetSelect);
